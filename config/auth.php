...
return [
    ...
    */
    ...
    'guards' => [
        ...
        'admin' => [
            'driver' => 'session',
            'provider' => 'users', // Admins authenticate from 'users' table
        ],
        'employee' => [
            'driver' => 'session',
            'provider' => 'employees',
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may define the amount of seconds before a password confirmation times out, and the user is prompted to re-enter their password via the confirmation screen.
    |
    */
